...
class DummyInput extends PolymerElement {
  static get template() {
    return html`
        <style>
          :host {
...
window.customElements.define('dummy-input', DummyInput);
