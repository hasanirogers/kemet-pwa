...
class ViewUtilities extends PageViewElement {
  render() {
    return html`
      ${StylesKemet}
      ${StylesShared}
      <section>
        ...
        <p>Kemet comes with some utility classes that assist with styling.</p>
        <h3>Visibility</h3>
        ...
        <h4>Font Sizers</h4>
        <p>In large applications you want to decouple the size of your text with your h1s, h2s, etc. You also don't want to control the text on a template level. Because of this kemet comes with size helpers <a href="/app/sass">which are configurable</a> with sass.</p>
...
window.customElements.define('view-utilities', ViewUtilities);
